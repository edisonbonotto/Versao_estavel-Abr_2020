...
%PRINCIPAL MATLAB code file for Principal.fig
...
%
%      PRINCIPAL('Property','Value',...) creates a new PRINCIPAL using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to Principal_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      PRINCIPAL('CALLBACK') and PRINCIPAL('CALLBACK',hObject,...) call the
%      local function named CALLBACK in PRINCIPAL.M with the given input
%      arguments.
%
%      *See GUI Options on GUIDE's Tools principal.  Choose "GUI allows only one
...
% Last Modified by GUIDE v2.5 09-Mar-2020 21:07:00
